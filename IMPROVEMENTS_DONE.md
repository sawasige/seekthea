...
`IMPROVEMENTS.md` の Round 1（コードレビュー由来）の対応済み項目を退避したアーカイブ。
2026-04-20 以降の PR で対応または WontFix と判断された項目。
...
- 実装後は本ファイルから IMPROVEMENTS_DONE.md (= 本ファイル) に退避（2026-05-08 退避完了）
